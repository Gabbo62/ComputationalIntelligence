...
class Game(object):
    ...
    def play(self, player1: Player, player2: Player) -> int:
        ...
        winner = -1
        move_time = tqdm.tqdm(desc="Move time", leave=False)
        while winner < 0:
            self.current_player_idx += 1
    ...
    def __move(self, from_pos: tuple[int, int], slide: Move, player_id: int) -> bool:
        ...
        # print("not take") if not acceptable else None
        if acceptable:
            acceptable = self.__slide((from_pos[1], from_pos[0]), slide)
            # print("not slide") if not acceptable else None
            if not acceptable:
    ...
    def __take(self, from_pos: tuple[int, int], player_id: int) -> bool:
        ...
        # print(self._board[from_pos], player_id, from_pos) if not acceptable else None
        if acceptable:
